...
> **Prerequisite**: Ensure `ClerkProvider` wraps your app. Load `clerk-setup` via `read_file` at `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-setup\SKILL.md` if needed.
>
...
Use `read_file` with the absolute path to load the reference file content:

| Task                                 | Absolute Path                                                                                  |
| ------------------------------------ | ---------------------------------------------------------------------------------------------- |
| Custom sign-in (Core 2 / LTS)        | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\core-2\custom-sign-in.md` |
| Custom sign-up (Core 2 / LTS)        | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\core-2\custom-sign-up.md` |
| Custom sign-in (Current SDK v7+)     | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\core-3\custom-sign-in.md` |
| Custom sign-up (Current SDK v7+)     | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\core-3\custom-sign-up.md` |
| Show component pattern (Current SDK) | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\core-3\show-component.md` |
...
2. For custom flows: check SDK version → load appropriate reference file using `read_file` (see table above)
3. For appearance: use `fetch_webpage` or check the documentation URLs from the table above
...
- `clerk-nextjs-patterns`, `clerk-orgs` — not installed locally; see https://clerk.com/docs
