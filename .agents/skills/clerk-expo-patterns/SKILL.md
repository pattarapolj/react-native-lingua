...
| Task                               | Absolute Path                                                                                              |
| ---------------------------------- | ---------------------------------------------------------------------------------------------------------- |
| Persist tokens with SecureStore    | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-expo-patterns\references\token-storage.md`      |
| OAuth (Google, Apple, GitHub)      | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-expo-patterns\references\oauth-deep-linking.md` |
| Protected screens with Expo Router | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-expo-patterns\references\protected-routes.md`   |
| Push notifications with user data  | `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-expo-patterns\references\push-notifications.md` |
...
- Load `clerk-custom-ui` via `read_file` at `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\SKILL.md` — Custom flows & appearance
