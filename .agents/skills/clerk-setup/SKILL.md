...
> **Next.js:** Create `proxy.ts` (Next.js <=15: `middleware.ts`). For advanced middleware strategies see https://clerk.com/docs/nextjs/middleware.
...
## See Also (Installed Locally)

Load these via `read_file` with the absolute path:

- `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-custom-ui\SKILL.md` — Custom sign-in/up components
- `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-expo-patterns\SKILL.md` — Expo / React Native patterns
- `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-webhooks\SKILL.md` — Webhook → database sync
- `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-backend-api\SKILL.md` — Backend REST API

## See Also (Not Installed)

Not available locally — refer to https://clerk.com/docs:

- `clerk-nextjs-patterns`, `clerk-react-patterns`, `clerk-vue-patterns`, `clerk-nuxt-patterns`
- `clerk-astro-patterns`, `clerk-tanstack-patterns`, `clerk-react-router-patterns`
- `clerk-chrome-extension-patterns`, `clerk-orgs`, `clerk-billing`, `clerk-testing`
- `clerk-swift`, `clerk-android`
