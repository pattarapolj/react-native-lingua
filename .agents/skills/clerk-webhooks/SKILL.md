...
For full handler examples per framework, load via `read_file` at `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-webhooks\references\frameworks.md`.
...
| --------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------- |
| `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-webhooks\references\frameworks.md` | Webhook handler examples for Express, Astro, Fastify, Nuxt, React Router, TanStack Start |
...
- Load `clerk-backend-api` via `read_file` at `d:\my-Project\duolingo-clone-project\.agents\skills\clerk-backend-api\SKILL.md` — Sync via direct API calls
- `clerk-orgs`, `clerk-billing` — not installed locally; see https://clerk.com/docs
